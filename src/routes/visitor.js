...
visitorRouters.get(
  "/:model/:process/:city/:owner/:availability/:buildingAge/:furnished/:rooms/:bathRooms/:rentDuration/:floors/:priceFrom/:priceTo",
  async (req, res) => {
    ...
    let filteredData = await req.model.readFiltered(
      process,
      city,
      owner,
      availability,
    ...
    if (filteredData) {
      ...
      res
        .status(403)
        .send(`Error: your filteration does not match any existing data`);
    }
  }
);
